...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    int sliderAllImages[] = {R.drawable.halo, R.drawable.cariaku, R.drawable.menghubungi};
    int sliderAllTittle[] = {R.string.screen1, R.string.screen2, R.string.screen3};
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        sliderTitle.setText(this.sliderAllTittle[position]);
